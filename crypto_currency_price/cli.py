...
@click.option("-v", "--verbose", is_flag=True, envvar='VERBOSE', help="verbose output")
@click.option('-i', '--input', "_input", type=click.Choice(CURRENCIES, case_sensitive=False))
@click.option('-o', '--output',"_output", type=click.Choice(CURRENCIES, case_sensitive=False))
@click.option('-c', 
    '--config-file', 
